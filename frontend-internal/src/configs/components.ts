...
export const components = {
    ...
    ScheduleLayout: lazy(() => import("@/modules/hrm/shifts/ScheduleLayout")),
    AttendanceLayout: lazy(() => import("@/modules/hrm/shifts/AttendanceLayout")),
    ...
    NavigationBarConfig: lazy(() => import("@/modules/config/NavigationBarConfig")),

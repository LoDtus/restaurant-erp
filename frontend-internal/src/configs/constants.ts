export const NAVIGATION_TABS = [
    ...
    { id: "hrm", path: "/hrm", label: "Nhân sự", icon: null, subTabs: [
    ...
    { id: "logistic", path: "/logistic", label: "Kho hàng", icon: null, subTabs: [
    ...
    { id: "catalog", path: "/catalog", label: "Danh mục", icon: null, subTabs: [
